...
static char *openurlcmd[] = {
    ...
    "'s/^www./http:\\/\\/www\\./g' | rofi -dmenu -i -p 'Follow which url?' -l "
    "10 | "
    "xargs -r xdg-open",
    "externalpipe", NULL};
...
static char *copyurlcmd[] = {
    ...
    "'(((http|https)://|www\\.)[a-zA-Z0-9.]*[:]?[a-zA-Z0-9./"
    "&%?=_-]*)|((magnet:\\?xt=urn:btih:)[a-zA-Z0-9]*)' | uniq | sed "
    "'s/^www./http:\\/\\/www\\./g' | rofi -dmenu -i -p 'Copy which url?' -l 10 "
    "| tr "
...
static Shortcut shortcuts[] = {
    ...
    {CTRLSHIFTMOD, XK_P, selpaste, {.i = 0}},
    ...
    {CTRLSHIFTMOD, XK_Up, zoom, {.f = +1}},
    {CTRLSHIFTMOD, XK_Down, zoom, {.f = -1}},
